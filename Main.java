public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("La marca del coche es " + CocheMedido.marca + " Con modelo " + CocheMedido.modelo + " Alcanza una velocidad de " + velocidadGeneral + " kilometros por hora");
